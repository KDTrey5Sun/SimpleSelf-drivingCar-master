...
class AbstractCar:
    def __init__(self, max_vel, rotation_vel):
        # Default start position; can be overridden per instance using set_start_pos
        self.START_POS = (CENTER_X, HEIGHT - 80)
        # Some type-checkers complain if base doesn't define IMG; provide a fallback
        self.IMG = getattr(self, 'IMG', GREEN_CAR)
        self.img = self.IMG
    ...
    # Prefer using this instead of assigning START_POS class attribute directly
